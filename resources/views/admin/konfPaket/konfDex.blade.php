@extends('layouts.app', ['title' => __('Daftar Sudah di Konfirmasi')])

@section('content')
    @include('admin.paket.partials.header', ['title' => __('Daftar Sudah di Konfirmasi')  ])
                ...
                <div class="card shadow">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            @empty
                                <tr>
                                    <td class="text-center" colspan="6">Belum ada Konfirmasi yang masuk</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
